  ...
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Books', [
      ...
      },
      {
        ...
        description: "In this brilliant work, the most influential philosopher since Sartre suggests that such vaunted reforms as the abolition of torture and the emergence of the modern penitentiary have merely shifted the focus of punishment from the prisonerâ€™s body to his soul.",
        publicationYear: '1984',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      ...
      },
      {
        ...
        description: "Michel Foucault examines the archeology of madness in the West from 1500 to 1800 â€“ from the late Middle Ages, when insanity was still considered part of everyday life and fools and lunatics walked the streets freely, to the time when such people began to be considered a threat, asylums were first built, and walls were erected between the â€œinsaneâ€ and the rest of humanity.",
        publicationYear: '1984',
        createdAt: new Date(),
        updatedAt: new Date()
      },
