...
module.exports = {
      ...
      updatedAt: new Date() },
  {
      ...
      description: "Paul Kalanithi didn't set out to become a writer — in fact, he was an M.D. with more than a decade of training as a neurosurgeon, until he was diagnosed with Stage IV lung cancer. After switching from doctor to patient, he set out to write this memoir to examine what makes life worth living. ",
      publicationYear: '1984',
      createdAt: new Date(),
      updatedAt: new Date() },
  {
      ...
      updatedAt: new Date() },
  {
      author: 'Amy Poehler',
      title: 'Yes Please' ,
      description: "Amy Poehler's collection of essays is as funny as you'd expect from the former star of The Upright Citizens Brigade, Saturday Night Live and Parks and Recreation — but it also contains lots of useful real-world wisdom, such as advice about when to be funny and when to get serious. ",
      publicationYear: '1984',
      createdAt: new Date(),
      updatedAt: new Date() },
  {
      ...
      updatedAt: new Date() },
  {
      ...
      description: 'Jeannette Walls describes her unconventional and nomadic upbringing, being raised by nonconformist parents — including an alcoholic father — who taught them how to "embrace life fearlessly." The story pops off the page so strongly, it was adapted into a feature film starring Brie Larson.',
      publicationYear: '1984',
      createdAt: new Date(),
      updatedAt: new Date() },
  {
  ...
  {
      author: 'The Martian',
      title: 'Andy Weir', publication_year: '1969',
      description: 'example description',
      publicationYear: '1984',
      createdAt: new Date(),
      updatedAt: new Date()},
...
const reviews = queryInterface.bulkInsert('Reviews', [
  {
      ...
      {
      book_id: 'Boies That Matter: On the Discursive Limits of "Sex"',
...
const book_genres = queryInterface.bulkInsert('Book_Genres', [
  {book_id: books[1].id, genre_id: 3},
  {book_id: books[2].id, genre_id: 3},
  {book_id: books[3].id, genre_id: 3},
  {book_id: books[4].id, genre_id: 3},
  {book_id: books[5].id, genre_id: 3},
  {book_id: books[6].id, genre_id: 3},
  {book_id: books[7].id, genre_id: 3},
  {book_id: books[8].id, genre_id: 3},
  {book_id: books[9].id, genre_id: 3},
  {book_id: books[10].id, genre_id: 3},
  {book_id: books[11].id, genre_id: 1},
  {book_id: books[12].id, genre_id: 1},
  {book_id: books[13].id, genre_id: 1},
  {book_id: books[14].id, genre_id: 1},
  {book_id: books[15].id, genre_id: 1},
  {book_id: books[16].id, genre_id: 1},
  {book_id: books[17].id, genre_id: 1},
  {book_id: books[18].id, genre_id: 1},
  {book_id: books[19].id, genre_id: 1},
  {book_id: books[20].id, genre_id: 1},
  {book_id: books[21].id, genre_id: 2},
  {book_id: books[22].id, genre_id: 2},
  {book_id: books[23].id, genre_id: 2},
  {book_id: books[24].id, genre_id: 2},
  {book_id: books[25].id, genre_id: 2},
  {book_id: books[26].id, genre_id: 2},
  {book_id: books[27].id, genre_id: 2},
  {book_id: books[28].id, genre_id: 2},
  {book_id: books[29].id, genre_id: 2},
  {book_id: books[30].id, genre_id: 2},
], { returning: true }
);
},
  down: async (queryInterface, Sequelize) => {
      ...
      await queryInterface.bulkDelete('Books_Genres', null, {});
  },
};
